            ...
            if (course.id == id) {
                        ...
                        getData("UserCompletion", function (completions) {
                            ...
                            setData("CurrentCourse", JSON.stringify(lmsDirectory), function () {
                                getData("UserLevel", function (userLevel) {
                                    ...
                                    var h2 = $("<h2>" + lmsDirectory.name + "</h2>");
                                    element.append(h2);
                ...
                $.each(courseDetails, function (index, details) {
                    if (details.isChapter) {
                        ...
                        var li = "";
                        if (details.isPassed) {
                            li = $("<li class='completed'><div class='icon' aria-hidden='true'><svg viewBox='0 0 24 24'><path d='M6 12.5l4 4 8-10' /></svg></div>" + name + "</li>");
                            li.click(function () {
                            ...
                            if (firstIncompleteFound) {
                                ...
                                li = "<li class='current'><div class='icon' aria-hidden='true'><svg viewBox='0 0 24 24'><polygon points='8,5 19,12 8,19' fill='currentColor' /></svg></div>" + name + "</li>";
                            } else {
                                li = "<li class='upcoming'><div class='icon' aria-hidden='true'><svg viewBox='0 0 24 24'><circle cx='12' cy='12' r='10' fill='none' stroke='currentColor' stroke-width='2' /></svg></div>" + name + "</li>";
                            }
                        }
                        $(".progress-list").append(li);
                    }
                });
                var certLi = li = "<li class='upcoming certLi'><div class='icon' aria-hidden='true'><svg viewBox='0 0 24 24'><circle cx='12' cy='12' r='10' fill='white' stroke='silver' stroke-width='2' /></svg></div>Certificate</li>";
